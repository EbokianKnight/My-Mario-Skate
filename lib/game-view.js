...
GameView.prototype.bindKeyHandlers = function () {
  ...
  this.orient = window.addEventListener('deviceorientation', function(event){
    if (event.beta > 4 && event.gamma > 4) { //down right
      that.keysDown.up = false;
      that.keysDown.right = true;
      that.keysDown.down = true;
      that.keysDown.left = false;
    } else if (event.beta > 4 && event.gamma < -4) {//down left
      that.keysDown.up = false;
      that.keysDown.right = false;
      that.keysDown.down = true;
      that.keysDown.left = true;
    } else if (event.beta > 4) { //down
      that.keysDown.up = false;
      that.keysDown.right = false;
      that.keysDown.down = true;
      that.keysDown.left = false;
    } else if (event.beta < -4 && event.gamma > 4) { //up right
      that.keysDown.up = true;
      that.keysDown.right = true;
      that.keysDown.down = false;
      that.keysDown.left = false;
    } else if (event.beta < -4 && event.gamma < -4) { //up left
      that.keysDown.up = true;
      that.keysDown.right = false;
      that.keysDown.down = false;
      that.keysDown.left = true;
    } else if (event.beta < -4) { // up
      that.keysDown.up = true;
      that.keysDown.right = false;
      that.keysDown.down = false;
      that.keysDown.left = false;
    } else if (event.gamma > -4 && event.gamma < 4 && event.beta > -4 && event.beta < 4){ //middle-ish
      that.keysDown.up = false;
      that.keysDown.right = false;
      that.keysDown.down = false;
      that.keysDown.left = false;
